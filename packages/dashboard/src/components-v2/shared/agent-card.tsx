...
import { MoreVertical, Copy, Settings, Trash2, Eye, Key } from "lucide-react";
...
export function AgentCardV2({ agent, onViewLogs, onEdit, onDelete, onRegenerate, onManageRules }: AgentCardV2Props) {
  ...
  return (
    <div className="group relative overflow-hidden rounded-lg border border-white/8 bg-[#1f1f1f] transition-all duration-200 hover:border-white/15 hover:bg-[#2C2C2E] hover:scale-[1.02]">
      {/* Content */}
      <div className="p-6">
        {/* Header */}
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2 rounded-lg border border-white/8 bg-white/5 px-3 py-2 group/key hover:bg-white/10 transition-all duration-200">
            <code className="flex-1 text-xs font-mono text-white/70 truncate">
              {agent.api_key.slice(0, 20)}...
            </code>
            <button
              onClick={copyApiKey}
              className="shrink-0 p-1.5 rounded-md text-white/50 hover:text-white/95 hover:bg-white/10 transition-all duration-200"
            >
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="flex-1 rounded-lg bg-[#FAFAFA] text-[#141414] hover:bg-[#FFFFFF] h-9 font-medium transition-all duration-200"
          >
          ...
          <Button
            ...
            className="rounded-lg border-white/8 bg-white/5 text-white/95 hover:bg-white/10 hover:border-white/15 h-9 transition-all duration-200"
          >
            Edit
          </Button>
          <DropdownMenu>
